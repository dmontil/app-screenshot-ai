...
function travelPlates(brandKit: BrandKit): BackgroundPlateSpec[] {
  return [
    plate({
      ...
      palette: { base: "#F7F1E7", ink: "#9B8972", accent: brandKit.palette.accent },
    ...
    plate({
      ...
      style: "literary-map-sketch",
      texture: "aged-paper",
      motifs: ["coastline-map", "book-margin", "route-dashes"],
      palette: { base: "#FBF5E9", ink: "#B0A18B", accent: brandKit.palette.accent },
    ...
    plate({
      ...
      texture: "soft-noise",
      motifs: ["paper-folds", "route-arc", "margin-notes"],
      palette: { base: "#F4E8D5", ink: "#A68E70", accent: brandKit.palette.accent },
